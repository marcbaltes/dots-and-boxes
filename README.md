...
- Open terminal and type ```python -m SimpleHTTPServer``` this will start a local server at ```localhost:8000```
- Type ```localhost:8000``` into the URL of your browser and then click ```DotsAndBoxes.html``` on that page
### Gameplay
